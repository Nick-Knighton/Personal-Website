export const projects = [
    {
      ...
      description:
        "The Rev's American Grill website project involved a team of five, with me as the lead front-end designer. Collaborating with my talented colleagues, we utilized React and Django to create an appealing and user-friendly website. I took charge of designing the layout, integrating various Google APIs for enhanced functionality, and ensuring seamless connectivity between all elements. Leveraging GitHub for version control and MySQL for storing menu items and inventory, we successfully delivered a dynamic website that allowed customers to explore the menu, servers to input orders, and managers to check stock levels.",
      technology: [
        "React",
        "Python",
        "JavaScript",
...

    {
      ...
      images: [
        { src: "/Project Photos/Personal Website/home-screen" },
        { src: "/Project Photos/Personal Website/countries-visited" },
      ],
    },

    {
      ...
      images: [
        { src: "/Project Photos/Personal Website/home-screen.png" },
        { src: "/Project Photos/Personal Website/countries-visited.png" },
      ],
    },
    {
